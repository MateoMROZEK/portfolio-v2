...
export function CvContent({ age }: { age: number }) {
    ...
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-1 gap-x-12 gap-y-16 lg:grid-cols-[1.5fr_1fr]">
        ...
        <div className="space-y-14">
          <section>
            <SectionHeading className="mb-6">{t.cv.about}</SectionHeading>
            <motion.div
          ...
          <section>
            <SectionHeading className="mb-6">{t.cv.otherExperience}</SectionHeading>
            <motion.ul
              variants={staggerContainer}
              initial="hidden"
              whileInView="show"
        ...
        <div className="space-y-14 border-line lg:border-l lg:pl-12">
          <section>
            <SectionHeading className="mb-4">{t.cv.profile}</SectionHeading>
            <p className="text-[14px] leading-relaxed text-ink-soft">{pick(cv.profile)}</p>
          </section>

          <section>
            <SectionHeading className="mb-6">{t.cv.education}</SectionHeading>
          ...
          <section>
            <SectionHeading className="mb-6">{t.cv.skills}</SectionHeading>
          ...
          <section>
            <SectionHeading className="mb-4">{t.cv.certifications}</SectionHeading>
          ...
          <section>
            <SectionHeading className="mb-6">{t.cv.hobbies}</SectionHeading>
