...
export default function RootLayout({
  ...
  <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div className="flex lg:hidden">
      <button type="button" id="mobileMenuButton" className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white">
    ...
    <div className="hidden lg:flex lg:gap-x-12">
      <a href="/#a-propos" className="text-xl font-bold leading-6 text-white">A Propos</a>
      <a href="/portfolio" className="text-xl font-bold leading-6 text-white">Portfolio</a>
    </div>
  </nav>
  {/* Mobile menu, show/hide based on menu open state. */}
  <div id="mobileMenu" className="hidden lg:hidden" role="dialog" aria-modal="true">
    ...
    <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 h-[100vh]">
      <div className="flex items-center justify-between">
        ...
        <button type="button" id="closeMobileMenuButton" className="-m-2.5 rounded-md p-2.5 text-gray-700">
